    ...
    <section className="campaign-config" aria-labelledby={`${platform}-configuration-title`}>
      ...
      <div className="config-grid">
        <article className="config-card device-picker">
          ...
          <Group gap="xs">
            <Button size="compact-sm" variant="light" disabled={!eligible.length} onClick={() => dispatch({ type: "set-campaign-devices", platform, deviceIds: eligible.map((item) => item.id) })}>Seleccionar elegibles</Button>
