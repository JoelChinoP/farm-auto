            ...
            <tbody>
              {campaigns.map((campaign) => (
                <tr key={campaign.id} data-unknown={hasUnknown(campaign)}>
                  ...
                  <td>{campaign.mode === "live" ? "Tap tap" : [campaign.actions.like && "Like", campaign.actions.comment && "Comentario", campaign.actions.share && "Compartir"].filter(Boolean).join(" + ")}</td>
        ...
        {detail && (
          <div className="history-detail">
            ...
            <dl className="detail-list wide">
              ...
              <div><dt>Acciones</dt><dd>{detail.mode === "live" ? "Tap tap calibrado" : [detail.actions.like && "Like", detail.actions.comment && "Comentario", detail.actions.share && "Compartir"].filter(Boolean).join(" + ")}</dd></div>
            </dl>
